...
// قائمة محطات الحافلات الثابتة
var busStations = [
    { id: 1, name: "المحطة الأولى" },
    { id: 2, name: "المحطة الثانية" },
    { id: 3, name: "المحطة الثالثة" }
];
...
function addfieldboard() {
    ...
    // إضافة المحطات يدويًا
    busStations.forEach(element => {
